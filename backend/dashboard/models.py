...
class MasterIncident(models.Model):
    ...
    PRMO = models.BooleanField(verbose_name=_('PRMO'), default=False)
    UNDSS = models.BooleanField(verbose_name=_('UNDSS'), default=False)
    INSO = models.BooleanField(verbose_name=_('INSO'), default=False)
