...
class Undss(models.Model):
    ...
    Time_of_Incident = models.TimeField(_("Time Of Incident"), null=True, blank=True)
    ...
    Kill_Natl = models.PositiveIntegerField(verbose_name='Killed - National', null=True, blank=True)
    Kill_Intl = models.PositiveIntegerField(verbose_name='Killed - International', null=True, blank=True)
    Kill_ANSF = models.PositiveIntegerField(verbose_name='Killed - ANSF', null=True, blank=True)
    Kill_IM = models.PositiveIntegerField(verbose_name='Killed - IM', null=True, blank=True)
    Kill_ALP_PGM = models.PositiveIntegerField(verbose_name='Killed - ALP_PGM', null=True, blank=True)
    Kill_AOG = models.PositiveIntegerField(verbose_name='Killed - AOG', null=True, blank=True)
    Kill_ISKP = models.PositiveIntegerField(verbose_name='Killed - ISKP', null=True, blank=True)
    Inj_Natl = models.PositiveIntegerField(verbose_name='Injured - National', null=True, blank=True)
    Inj_Intl = models.PositiveIntegerField(verbose_name='Injured - International', null=True, blank=True)
    Inj_ANSF = models.PositiveIntegerField(verbose_name='Injured - ANSF', null=True, blank=True)
    Inj_IM = models.PositiveIntegerField(verbose_name='Injured - IM', null=True, blank=True)
    Inj_ALP_PGM = models.PositiveIntegerField(verbose_name='Injured - ALP_PGM', null=True, blank=True)
    Inj_AOG = models.PositiveIntegerField(verbose_name='Injured - AOG', null=True, blank=True)
    Inj_ISKP = models.PositiveIntegerField(verbose_name='Injured - ISKP', null=True, blank=True)
    Abd_Natl = models.PositiveIntegerField(verbose_name='Abducted - National',null=True, blank=True)
    Abd_Intl = models.PositiveIntegerField(verbose_name='Abducted - International',null=True, blank=True)
    Abd_ANSF = models.PositiveIntegerField(verbose_name='Abducted - ANSF',null=True, blank=True)
    Abd_IM = models.PositiveIntegerField(verbose_name='Abducted - IM',null=True, blank=True)
    Abd_ALP_PGM = models.PositiveIntegerField(verbose_name='Abducted - ALP_PGM',null=True, blank=True)
