    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reference.Province', verbose_name='Province_')),
            ],
        ),
        migrations.CreateModel(
            name='CityVillage',
            fields=[
                ...
                ('district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reference.District', verbose_name='District_')),
                ('province', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reference.Province', verbose_name='Province__')),
            ],
        ),
        migrations.CreateModel(
            name='Area',
